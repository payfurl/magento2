<?php
namespace Payfurl\Payment\Setup\Patch\Data;
...
class AddPayfurlPaymentId implements DataPatchInterface
{
    ...
    public function apply()
    {
        ...
        try {
            ...
            $this->customerSetup->addAttribute(
                ...
                'payfurl_payment_id',
                [
                    'label' => 'Customer PayFURL Payment Id',
                    'required' => 0,
                    'position' => 333,
                    'system' => 0,
                    'user_defined' => 1,
            ...
            $attribute = $this->customerSetup->getEavConfig()
                ->getAttribute(CustomerMetadataInterface::ENTITY_TYPE_CUSTOMER, 'payfurl_payment_id');
